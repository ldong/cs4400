  ...
  <body>
    <?php
      ...
      // insert student current records
        ...
        if($query == "A" || $query == "B")
        {
         // INSERT INTO Applied_To_Tutor_For VALUES('$username','$courses')
          echo "A,B";
        }
...
echo "<button onclick=\"parent.location='https://academic-php.cc.gatech.edu/~ldong36/demo/welcomestudent.html'\">Homepage<button>;\n";
